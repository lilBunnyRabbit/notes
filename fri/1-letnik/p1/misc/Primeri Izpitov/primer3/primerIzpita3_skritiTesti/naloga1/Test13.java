...
public class Test13 {
    ...
    public static void main(String[] args) {
        ...
        boolean[][] m1 = {
            ...
            {T, F, F, T, T, T, F, T, F, T, F, F},
            {F, T, T, F, T, T, T, T, F, F, F, T},
            {T, F, T, T, F, T, T, T, T, T, F, T},
            {F, F, T, T, T, F, F, T, F, T, T, F},
            {T, F, F, T, T, F, F, F, F, T, F, F},
            {F, F, T, T, T, T, F, F, F, T, T, T},
            {T, F, F, F, T, F, F, F, F, F, F, F},
            {F, F, T, F, T, T, T, T, F, F, T, F},
            {F, F, F, F, F, T, F, T, F, T, F, T},
            {F, F, F, T, T, F, F, T, F, F, T, F},
        };
        ...
        boolean[][] m2 = {
            ...
            {F, T, F, F, F, F, F, T, F, T, F, T},
            {F, T, F, F, T, T, F, F, T, F, F, F},
            {F, T, F, T, F, F, F, F, F, F, F, F},
            {F, T, F, T, F, F, F, F, F, F, F, F},
            {T, T, F, F, F, F, F, F, T, F, T, T},
            {F, T, T, F, F, F, F, F, F, F, F, F},
            {F, T, F, T, F, F, T, F, F, F, F, T},
            {F, T, T, F, F, F, F, F, F, F, F, F},
            {F, F, F, F, F, F, T, F, F, F, F, T},
            {F, T, T, F, F, F, T, F, T, F, T, F},
        };
        ...
        boolean[][] m3 = {
            ...
            {F, T, T, F, F, F, T, T, F, F, F, F},
            {F, T, T, F, F, F, F, F, F, F, F, F},
            {T, T, T, F, F, F, F, F, T, F, F, F},
            {F, T, T, T, F, F, F, T, T, T, T, T},
            {F, F, T, T, F, F, T, F, F, F, T, F},
            {F, T, T, F, F, T, T, F, F, F, F, F},
            {F, T, T, F, F, F, T, F, F, F, F, T},
            {F, T, T, F, F, F, T, T, F, F, F, F},
        ...
        boolean[][] m4 = {
            ...
            {T, T, F, T, T, T, F, T, F, F, F, T},
            {F, F, T, F, T, T, F, T, T, T, T, T},
            {F, F, T, T, F, T, F, F, F, F, T, F},
            {T, F, T, T, T, F, T, T, T, T, T, F},
            {T, F, F, F, F, T, F, F, F, F, F, F},
            {F, F, T, T, F, T, F, F, F, T, T, T},
            {F, F, F, T, F, T, F, F, F, T, T, T},
        ...
        boolean[][] m5 = {
            ...
            {T, T, F, F, T, F, T, T, T, T, T, T},
            {T, T, F, F, F, F, F, F, F, F, F, F},
            {T, T, T, F, F, T, F, T, F, T, T, T},
            {T, T, F, F, T, F, F, F, T, F, F, F},
            {T, T, T, F, F, F, F, T, F, F, T, T},
            {T, T, T, F, T, F, T, F, T, F, F, F},
            {T, F, T, F, F, T, F, T, F, F, F, T},
            {F, T, T, F, T, F, F, F, F, F, T, F},
        ...
        boolean[][] m6 = {
            ...
            {T, F, T, F, F, F, F, F, F, F, F, F},
            {T, T, F, T, T, F, F, F, T, F, T, F},
            {T, F, T, F, F, T, T, T, T, F, T, F},
            {F, F, T, F, F, T, T, T, T, T, T, T},
            {F, F, F, T, T, F, F, F, T, T, F, T},
            {F, F, F, T, T, F, F, T, F, F, T, T},
            {T, F, F, T, T, F, T, F, F, F, F, F},
            {T, F, T, T, T, T, F, F, F, T, F, F},
            {T, F, F, F, T, T, F, F, T, F, F, F},
            {F, F, T, T, T, F, T, F, F, F, F, T},
            {F, F, F, F, T, T, T, F, F, F, T, F},
        };
        System.out.println(Graf.imaEulerjevObhod(m6));

        boolean[][] m7 = {
            {F, T, T, T, T, T, T, T, T, T, T, T},
            {T, F, F, F, F, F, T, F, T, F, T, F},
            {T, F, F, T, F, F, F, F, F, F, F, F},
            {T, F, T, F, F, F, F, F, F, F, F, F},
            {T, F, F, F, F, F, T, T, T, T, T, T},
            {T, F, F, F, F, F, T, F, T, T, T, T},
        ...
        boolean[][] m8 = {
            {F, T, T, F, T, T, T, F, T, F, F, F},
            {T, F, F, F, T, F, F, F, F, F, F, F},
            {T, F, F, T, F, T, F, F, T, F, F, F},
            {F, F, T, F, T, T, T, T, T, T, T, F},
            {T, T, F, T, F, F, F, F, F, T, F, F},
            {T, F, T, T, F, F, F, F, F, T, F, F},
            {T, F, F, T, F, F, F, T, T, T, T, T},
            {F, F, F, T, F, F, T, F, F, F, F, F},
            {T, F, T, T, F, F, T, F, F, F, T, T},
            {F, F, F, T, T, T, T, F, F, F, F, F},
            {F, F, F, T, F, F, T, F, T, F, F, T},
            {F, F, F, F, F, F, T, F, T, F, T, F},
        };
        System.out.println(Graf.imaEulerjevObhod(m8));

        boolean[][] m9 = {
            {F, T, F, F, F, F, F, F, F, T, F, F},
            {T, F, T, T, T, T, F, T, T, T, T, T},
            {F, T, F, F, F, F, F, F, F, F, T, F},
            {F, T, F, F, F, T, T, T, F, F, F, T},
            {F, T, F, F, F, F, F, T, F, F, F, F},
            {F, T, F, T, F, F, T, F, T, F, T, T},
            {F, F, F, T, F, T, F, F, F, F, F, F},
            {F, T, F, T, T, F, F, F, T, T, T, F},
            {F, T, F, F, F, T, F, T, F, T, T, T},
            {T, T, F, F, F, F, F, T, T, F, F, F},
            {F, T, T, F, F, T, F, T, T, F, F, T},
            {F, T, F, T, F, T, F, F, T, F, T, F},
        };
        ...
        boolean[][] m11 = {
            ...
            {T, F, F, T, F, F, F, F, T, F, F, T},
            {F, F, F, F, F, F, F, T, F, T, T, T},
            {T, F, F, F, T, F, F, F, T, F, F, T},
            {T, T, F, F, F, F, F, F, T, F, F, T},
            {T, F, T, F, F, F, F, T, T, T, T, F},
        };
        ...
        boolean[][] m12 = {
            ...
            {T, F, F, T, T, T, T, F, T, T, T, F},
            {T, F, T, F, T, T, F, F, T, T, T, F},
            {F, F, T, T, F, F, F, F, F, T, F, F},
            {T, F, T, T, F, F, T, F, F, F, F, F},
            {F, F, T, F, F, T, F, F, F, F, F, F},
            {F, T, F, F, F, F, F, F, T, F, F, F},
            {F, F, T, T, F, F, F, T, F, T, F, F},
            {F, F, T, T, T, F, F, F, T, F, T, F},
        ...
        boolean[][] m13 = {
            ...
            {T, F, T, T, T, T, T, T, T, F, T, F},
            {T, T, F, F, T, F, F, F, F, F, T, F},
            {T, T, F, F, F, F, F, F, F, F, F, F},
            {F, T, T, F, F, T, T, F, T, F, T, T},
            {F, T, F, F, T, F, F, F, F, F, F, F},
            {T, T, F, F, T, F, F, F, F, T, F, T},
            {F, T, F, F, F, F, F, F, F, F, F, T},
            {F, T, F, F, T, F, F, F, F, F, F, F},
            {F, F, F, F, F, F, T, F, F, F, T, F},
            {F, T, T, F, T, F, F, F, F, T, F, F},
        ...
        boolean[][] m14 = {
            ...
            {T, F, F, F, T, F, F, F, F, F, F, F},
            {T, T, F, F, F, F, T, F, F, T, F, F},
            {F, F, T, F, F, T, T, T, T, F, T, T},
            {F, T, F, F, T, F, F, T, T, T, T, T},
            {F, T, F, T, T, F, F, T, F, F, T, T},
            {F, T, F, F, T, T, T, F, T, F, F, T},
            {F, T, F, F, T, T, F, T, F, F, F, F},
            {F, F, F, T, F, T, F, F, F, F, F, F},
            {T, T, F, F, T, T, T, F, F, F, F, T},
            {F, T, F, F, T, T, T, T, F, F, T, F},
        };
        System.out.println(Graf.imaEulerjevObhod(m14));

        boolean[][] m15 = {
            {F, T, F, T, T, F, T, F, F, F, F, F},
        ...
        boolean[][] m16 = {
            ...
            {T, F, T, T, F, F, T, T, F, F, T, F},
            {T, F, T, T, T, T, F, T, F, T, F, T},
            {T, F, T, T, F, T, T, T, F, F, T, F},
        };
        ...
        boolean[][] m17 = {
            ...
            {F, F, T, T, T, F, T, F, F, F, F, F},
            {F, F, T, T, F, T, F, F, T, F, F, F},
            {F, F, T, T, F, F, F, F, F, F, F, F},
            {F, F, F, F, F, F, T, F, F, T, T, T},
            {F, F, F, T, T, F, F, F, T, F, T, F},
        ...
        boolean[][] m18 = {
            ...
            {F, F, T, F, T, F, F, F, F, T, F, T},
            {T, F, F, F, F, F, F, T, T, F, T, F},
            {F, F, F, F, T, F, T, F, T, F, T, F},
            {F, F, T, F, F, F, T, T, F, T, T, T},
            {F, F, F, T, F, T, F, F, T, F, T, F},
        ...
        boolean[][] m19 = {
            {F, T, T, F, T, T, T, T, F, F, F, F},
            {T, F, F, F, F, F, F, F, F, T, F, F},
            {T, F, F, T, F, T, F, F, T, F, F, F},
            {F, F, T, F, T, F, T, T, T, T, T, F},
            {T, F, F, T, F, T, T, T, T, T, T, T},
            {T, F, T, F, T, F, F, F, F, F, T, F},
            {T, F, F, T, T, F, F, T, F, F, F, F},
            {T, F, F, T, T, F, T, F, F, F, F, F},
            {F, F, T, T, T, F, F, F, F, F, F, T},
            {F, T, F, T, T, F, F, F, F, F, T, F},
        ...
        boolean[][] m20 = {
            ...
            {F, F, T, F, F, T, F, T, T, T, T, F},
            {F, T, T, F, F, F, F, T, T, F, T, T},
            {T, F, F, T, F, F, T, T, F, F, F, T},
            {F, F, F, F, F, T, F, F, F, T, T, T},
            {F, F, T, T, T, T, F, F, F, F, F, F},
            {F, F, T, T, T, F, F, F, F, T, T, T},
            {F, F, T, T, F, F, T, F, T, F, F, F},
            {F, F, T, T, T, F, T, F, T, F, F, T},
