...
public class Test12 {
    ...
    public static void main(String[] args) {
        ...
        boolean[][] m18 = {
            ...
            {T, F, F, T, F, F, F, F, F, F, F},
            {F, F, F, T, F, F, F, T, T, T, F},
            {F, T, T, F, F, F, F, T, T, T, T},
            {F, F, F, T, F, T, T, F, F, T, F},
            {F, F, T, T, F, T, T, F, F, F, F},
            {F, F, F, F, F, T, T, T, F, F, T},
            {T, F, F, F, F, F, T, F, F, T, F},
        };
