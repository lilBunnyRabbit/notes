public class Test22 {
    public static void main(String[] args) {
        ...
        boolean[][] p = {
            ...
            {F, T, F, F, F, T, T, T, F, F, T, F, T, F, F, F, F, F, F, F},
            {F, T, F, F, T, F, T, F, T, F, F, F, F, T, F, F, F, F, T, F},
            {F, F, F, F, F, F, T, F, F, T, F, F, F, F, F, T, F, F, F, F},
            {T, F, F, F, T, F, F, F, T, F, T, F, T, F, F, F, T, F, F, F},
            {F, T, T, F, T, F, F, F, F, F, F, T, F, F, F, F, F, F, F, F},
            {T, T, T, F, F, F, T, F, F, T, T, F, T, F, F, F, T, F, F, F},
            {T, F, T, F, F, T, F, F, T, F, F, T, T, F, F, F, T, F, F, T},
            {F, F, F, F, F, F, T, F, F, F, F, F, F, F, T, F, F, T, F, T},
            {F, F, F, F, F, F, F, F, F, F, F, F, T, F, F, T, F, F, T, F},
        };
