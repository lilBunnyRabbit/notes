...
public class Test14 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(recept.prviKorakZAkcijo("akcijaA"));   // 0
        System.out.println(recept.prviKorakZAkcijo("akcijaB"));   // 1
        System.out.println(recept.prviKorakZAkcijo("akcijaC"));   // -1
    }
}
