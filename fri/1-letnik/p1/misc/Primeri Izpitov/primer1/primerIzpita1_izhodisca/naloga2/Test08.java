...
public class Test08 {
    ...
    public static void main(String[] args) {
        ...
        Obrok obrok = new Obrok(
            new Jed[]{govejaJuha, oblozenaGovedina, prazenKrompir, solata, palacinke}
        );

        System.out.println((int) Math.round(obrok.masaSestavine("sol")));
        System.out.println((int) Math.round(obrok.masaSestavine("olje")));
        System.out.println((int) Math.round(obrok.masaSestavine("govedina")));
        System.out.println((int) Math.round(obrok.masaSestavine("pivo")));
        System.out.println((int) Math.round(obrok.masaSestavine("moka")));
    }
}
