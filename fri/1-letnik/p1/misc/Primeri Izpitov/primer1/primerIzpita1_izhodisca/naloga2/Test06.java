...
public class Test06 {
    ...
    public static void main(String[] args) {
        ...
        Obrok obrok1 = new Obrok(
            new Jed[]{govejaJuha, oblozenaGovedina, prazenKrompir, solata}
        );
        Obrok obrok2 = new Obrok(
            new Jed[]{prazenKrompir, solata}
        );

        System.out.println(obrok1.indeksNajboljKaloricneBeljakovinske());
        System.out.println(obrok2.indeksNajboljKaloricneBeljakovinske());
    }
}
