...
public class Test04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println((int) Math.round(oblozenaGovedina.kalorije()));
        System.out.println((int) Math.round(prazenKrompir.kalorije()));
        System.out.println((int) Math.round(solata.kalorije()));
        System.out.println((int) Math.round(palacinke.kalorije()));
    }
}
