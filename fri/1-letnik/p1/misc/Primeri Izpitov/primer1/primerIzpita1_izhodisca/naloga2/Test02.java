...
public class Test02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(oblozenaGovedina.jeBeljakovinska());
        System.out.println(prazenKrompir.jeBeljakovinska());
        System.out.println(solata.jeBeljakovinska());
        System.out.println(palacinke.jeBeljakovinska());
    }
}
