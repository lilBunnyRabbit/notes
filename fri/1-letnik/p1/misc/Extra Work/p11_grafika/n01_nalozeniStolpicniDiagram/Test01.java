...
public class Test01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Platno.ri(diagram.sirinaStolpca(500, 500)));
        System.out.println(Platno.ri(diagram.sirinaStolpca(600, 760)));
        System.out.println(Platno.ri(diagram.sirinaStolpca(800, 400)));
    }
}
