            ...
            if(Character.isDigit(element)) {
                if(levi == null) {
                    ...
                    if(i + 1 == niz.length()) {
                        ...
                        if(niz.charAt(i + 1) == '+' || niz.charAt(i + 1) == '-' || niz.charAt(i + 1) == ')') {
                            if(skupniIzraz != null) {
                                postFixenZapis.append(glavOperator);
                    ...
                    if(niz.charAt(i + 1) == '*' || niz.charAt(i + 1) == '/') { 
                        levi = new SestavljenIzraz(levi, trenOperator, desni); 
                        ...
                        if(trenOperator != 'n') {
                            skupniIzraz = new SestavljenIzraz(levi, trenOperator, desni);
                        }else {
                            skupniIzraz = new SestavljenIzraz(levi, glavOperator, desni);
                        }
                ...
                if(element == '(') { 
                    if(levi == null) {
                        ...
                        desni = zgradi(niz.substring(i + 1));
